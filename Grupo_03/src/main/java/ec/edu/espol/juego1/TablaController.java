...
public class TablaController implements Initializable, Runnable {
    ...
    public void ponerFichaCPU(int indice) {
        ...
        if (this.turno == JUGADOR2) {
            ...
            switch (indice) {
                case 0:
                    this.f1.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 1:
                    this.f2.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 2:
                    this.f3.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 3:
                    this.f4.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 4:
                    this.f5.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 5:
                    this.f6.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 6:
                    this.f7.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 7:
                    this.f8.setImage(jugador2.obtenFicha().getImage());
                    break;
                case 8:
                    this.f9.setImage(jugador2.obtenFicha().getImage());
                    break;
            }
            ...
            switch (indice) {
                case 0:
                    this.f1.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 1:
                    this.f2.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 2:
                    this.f3.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 3:
                    this.f4.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 4:
                    this.f5.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 5:
                    this.f6.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 6:
                    this.f7.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 7:
                    this.f8.setImage(jugador1.obtenFicha().getImage());
                    break;
                case 8:
                    this.f9.setImage(jugador1.obtenFicha().getImage());
                    break;
            }
