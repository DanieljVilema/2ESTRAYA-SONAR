package ec.edu.espol.estructura;

//import org.apache.commons.lang3.StringUtils;

import ec.edu.espol.p1.Messages;
import ec.edu.espol.p1.UsoTresEnRaya;
...
public class LogicaTresEnRaya {
	...
	public void getDibujaTablero(String separadorInterfaz) {
		...
		String[] jugadorXGanador = {VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.1"),VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.x.1"),VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.1")};
		String[] jugadorOGanador = {VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.2"),VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.x.2"),VERDE_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.2")};
		String[] jugadorX = {CYAN_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.1"),CYAN_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.x.1"),CYAN_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.1")};
		String[] jugadorO = {ROJO_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.2"),ROJO_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.x.2"),ROJO_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.forma.o.2")};
		String[] vacio = {"          ","          ","          "};
		String aux = "";
		...
		cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.inicio"), 1)+"\r\n";
		cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.vacio"), 1)+"\r\n";
		//Bucle for encargado de procesar parte del tablero, segun la informacion contenida actual:
		for(i = 0, j = 0 ; i < 9 ; i++) {
			if(i == 0 || i == 3 || i == 6) {
				aux += BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.separador.lateralIzquierdo");			//Procesamiento de los separadores laterales izquierdos de las casillas.
			}
			if(tablero[i] == 0) {
				aux += vacio[j];			//Si la casilla esta vacia, se procesa la figura vacia.
				if(i == 2 || i == 5 || i == 8) {
					aux += BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.separador.lateralDerecho");		//Procesamiento de los separadores laterales derechos de las casillas.
				}
				else {
					aux += BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.separador.central");	//Procesamiento de los separadores centrales de las casillas.
				}
			}
			...
			if(i == 2 || i == 5 || i == 8) {	//Cuando se tenga esa linea concatenada la pasamos a procesar:
				...
				//Si es la ultima linea antes de la siguiente casilla, se muestra en pequeño los numeros que hacen referencia a esa casilla:
					...
					cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.1") +AMARILLO_BRILLANTE+(i-1) + Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.2")+BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.3") +AMARILLO_BRILLANTE+ (i) + Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.4")+BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.5") +AMARILLO_BRILLANTE+(i+1) + Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.6")+BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.datos.7"), 1)+"\r\n";
					//Si no es la ultima linea divisoria se procesa la siguiente estructura:
					if(i < 8) {
						cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.medio"), 1)+"\r\n";
						cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.vacio"), 1)+"\r\n";
					}
					//Si es la ultima linea divisoria se procesa la siguiente estructura:
					else {
						cuerpo+=calcularMensajesInterfaz(separadorInterfaz, BLANCO+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.bloque.fin"), 1)+"\r\n";
						cuerpo+=calcularMensajesInterfaz(separadorInterfaz, AMARILLO_BRILLANTE+Messages.getString(idioma+"LogicaTresEnRaya.consola.getDibujaTablero.dibujo.mensaje.turno")+turno, 1)+"\r\n";
					}
					//Reiniciamos valores:
					j = 0;
					aux = "";
