...
public class Gato extends javax.swing.JFrame implements Runnable {
    ...
    public Gato() {
        ...
        /*LLenamos nuestro tablero de 0, vac�o.*/
    ...
    /*M�todo que ejecuta las operaciones al poner una ficha.*/
    public void movimiento( JLabel ficha ){
        ...
        /*Preguntamos si el juego termino o alguien gan�.*/
        if ( terminado() != 0){
            ...
            if ( terminado() == 1 ){
                jugador1.gano();
                jugador2.perdio();
                mensaje(jugador1.nombre + " gan�!");
            }else{
                jugador2.gano();
                jugador1.perdio();
                mensaje(jugador2.nombre + " gan�!");
            }
    ...
    /*M�todo que pone una ficha por la computadora.*/
    ...
    /*M�todo que "pone una ficha" en el tablero.*/
    public void ponerFicha( JLabel ficha ){
        ...
        /*Elegimos la ficha seg�n el turno*/
        if ( turno == JUGADOR1 )
            ficha.setIcon( jugador1.obtenFicha() );
        else
            ficha.setIcon( jugador2.obtenFicha() );
        
        /*Guardamos la representaci�n en el tablero*/
    ...
    /*M�todo que nos dice si el tablero se llen�.*/
    ...
    /*M�todo que nos dice si una casilla est� ocupada.*/
    public boolean estaOcupada( int casilla ){
        return ( tablero[casilla] != 0 );
    }
    
    /*M�todo que inicia los componentes del Gato.*/
    ...
    /*M�todo que recupera la informaci�n del jugador y la usa en el panel de usuario.*/
    public void mostrarInformacion(){
        ...
        /*Establecemos las estad�sticas del jugador.*/
    ...
    /*M�todo que muestra las estadisticas.*/
    ...
    /*M�todo que establece el texto de la etiqueta de descripci�n.*/
    ...
    /*M�todo que recoje el modelo y nos avisa que est� listo.*/
    public void recojerModelo(){
        /*Iniciamos los componentes del juego.*/
        iniciarJuego();
    }
    
    /*M�todo que inicia el juego una vez obtenido el modelo.*/
    public void iniciarJuego(){
        /*Creamos los jugadores seg�n el tipo de juego.*/
        if ( modelo.tipo_juego == HOMBREvsHOMBRE ){
            ...
            /*Mostramos su informaci�n, asignamos los nombres de jugador al panel.*/
            mostrarInformacion();
        } else {
            /*Jugadores*/
            this.jugador1 = new Jugador( modelo.nombre1, config.fichas[0] );
        ...
        /*Deshabilitamos el men� nuevo juego.*/
    ...
    /*M�todo que inicia un nuevo juego.*/
    ...
    private void initComponents() {
        ...
        Tablero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/tablero.png"))); // NOI18N
        getContentPane().add(Tablero);
        Tablero.setBounds(270, 20, 320, 400);

        Version.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
        ...
        panelEstadisticas.setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/bluefish-icon.png"))); // NOI18N
        ...
        txtEsta.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        txtEsta.setRows(5);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/SYSTEM ALERT NOTE ICON.png"))); // NOI18N
        jLabel1.setToolTipText("Estadísticas");
        panelEstadisticas.getContentPane().add(jLabel1);
        jLabel1.setBounds(90, 210, 0, 0);
            ...
            .add(panelJ2Layout.createSequentialGroup()
                ...
                .add(panelJ2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(panelJ2Layout.createSequentialGroup()
                        .add(lblEmpatados2)
                        .add(6, 6, 6)
                        .add(lblIcono2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .add(panelJ1Layout.createSequentialGroup()
                ...
                .add(panelJ1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(panelJ1Layout.createSequentialGroup()
                        .add(lblEmpatados)
                        .add(6, 6, 6)
                        .add(lblIcono, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                    .add(lblPerdidos))
                .addContainerGap())
        );
        ...
        lblSonido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/sonido.png"))); // NOI18N
        ...
        lblSonido.setBounds(550, 390, 60, 60);

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/fondo.jpg"))); // NOI18N
        fondo.setText("jLabel1");
        getContentPane().add(fondo);
        fondo.setBounds(0, 10, 37, 16);

        jTextField1.setText("jTextField1");
        getContentPane().add(jTextField1);
        jTextField1.setBounds(550, 40, 75, 26);
        getContentPane().add(jProgressBar1);
        jProgressBar1.setBounds(250, 420, 146, 4);

        mnuJuego.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/gdm.png"))); // NOI18N
        mnuJuego.setText("Juego");

        mnuIniciar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/gdm.png"))); // NOI18N
        ...
        mnuSuspender.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/exit.gif"))); // NOI18N
        ...
        mnuEstadisticas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/checkin.png"))); // NOI18N
        ...
        mnuConfigurar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/config.png"))); // NOI18N
        ...
        mnuAcerca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato/images/tooltip.png"))); // NOI18N
